...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when we subtract 4 from our number' do
      it 'returns 12' do
        previous_step = 16
  ...
  describe '#divide_by_two' do
    context 'when we divide by 2' do
      it 'returns 6' do 
        previous_step = 12
  ...
  describe '#subtract_random_number' do
    context 'we subtract oue number from the random number generated'
    subject(:next_game) {described_class.new(3)}

    it 'returns 7' do
      previous_step = 10
      result = next_game.subtract_random_number(previous_step)
  ...
  describe '#play' do
    ...
    context 'when the random number is 42.' do
      subject(:game_five) {described_class.new(42)}
      it 'will return 7' do
    ...
    context 'when the random number is 137' do
        subject(:game_six) {described_class.new(137)}
      it 'will return 7' do
        result = game_six.play
        expect(result).to eql(7)
